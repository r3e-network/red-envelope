export const messages = {
  ...
  sharePublisher: { en: "Publisher", zh: "发布者" },
  shareQrAlt: { en: "Share link QR code", zh: "分享链接二维码" },
  ...
  flowStatusLoading: { en: "Processing", zh: "处理中" },
  flowStatusSuccess: { en: "Success", zh: "成功" },
  flowStatusError: { en: "Error", zh: "失败" },
  flowHintWaitingUrl: { en: "Open this page with a valid envelope id in URL.", zh: "请通过 URL 携带有效红包 ID 打开页面。" },
  flowHintLoadingEnvelope: { en: "Loading envelope state from chain...", zh: "正在从链上加载红包状态..." },
  flowHintClaimingOnChain: { en: "Claim transaction submitted. Waiting for chain confirmation...", zh: "领取交易已提交，等待链上确认..." },
  flowHintReclaimingOnChain: { en: "Reclaim transaction submitted. Waiting for chain confirmation...", zh: "回收交易已提交，等待链上确认..." },
  flowHintOpeningEnvelope: { en: "Opening flow active. Complete open action in modal.", zh: "打开流程进行中，请在弹框中完成操作。" },
  flowHintTransferringEnvelope: { en: "Transfer flow active. Complete transfer in modal.", zh: "转让流程进行中，请在弹框中完成操作。" },
  flowHintNoAction: { en: "No available action for current wallet and envelope state.", zh: "当前钱包在该红包状态下暂无可执行操作。" },
  flowHintReadyAction: { en: "Ready. Use the primary action below to continue.", zh: "已就绪，请使用下方主操作继续。" },
